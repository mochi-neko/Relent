...
{
    [TestFixture]
    internal sealed class HttpResultWithDataTest
    {
        [Test]
        ...
        [Test]
        [RequiresPlayMode(false)]
        public void FailedToUnwrapRetryableResultTest()
        {
            var result = HttpResult.Retry<bool>("Test");
        ...
        {
            var result = HttpResult.Fail<bool>("Test");
            Func<bool> unwrap = () => result.Unwrap();
